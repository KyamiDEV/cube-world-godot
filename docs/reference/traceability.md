...
| 090–091 | `matrix-world.md` §2 | `WorldInfo` structure placement — 090 done (see the row above); 091+ is the generator that reads `StructurePlacement.is_placed_at()` and writes a `VoxelBuffer` | `world/structures/` | LOW | — |
